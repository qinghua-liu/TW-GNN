    ...
    def process(self):
        ...
        for example in raw_examples:
            ...
            prem_graph = Graph(fof_formula_transformer(self.statements[prem]),
                               rename=self.rename)
            c_nodes, c_edge_indices, c_term_walk_indices, \
                c_node_attrs, c_edge_attrs = self.graph_process(conj_graph)
            p_nodes, p_edge_indices, p_term_walk_indices, \
                p_node_attrs, p_edge_attrs = self.graph_process(prem_graph)
            data = PairData(
